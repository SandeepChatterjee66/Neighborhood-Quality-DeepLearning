...
labels = np.loadtxt('/home/gpuuser1/gpuuser1_a/sandeep/sandeep/digit_classification/embeddings/train/ffnn_model_10_labels.txt', dtype=str);
...
for i in $i_values; do
    ...
    python3 -c "import numpy as np; np.save('embeddings.npy', np.loadtxt(f'/home/gpuuser1/gpuuser1_a/sandeep/sandeep/digit_classification/embeddings/train/ffnn_model_${i}_embeddings.txt'))"
