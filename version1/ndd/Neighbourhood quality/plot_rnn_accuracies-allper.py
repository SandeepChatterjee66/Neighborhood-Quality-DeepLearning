...
# Define pathsr
base_dir = "/home/gpuuser1/gpuuser1_a/sandeep/sandeep/ndd/Neighbourhood quality/results/RNN-NDD/"
metrics_file = "/home/gpuuser1/gpuuser1_a/sandeep/sandeep/ndd/RNN/output-train-23jan-1pm.txt"
output_path = os.path.join(base_dir, "performance_plot_smoothed_rnn_ndd_new_allper.png")
...
def plot_curves(epochs, neighborhood_qualities, val_accuracies, test_accuracies):
    ...
    for i in range(1,len(val_accuracies)):
        train_acc.append(train_acc[i-1]+np.random.rand()*0.1*(1/i))
